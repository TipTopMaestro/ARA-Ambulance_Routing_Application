...
public class PathResponse {
    ...
    public PathResponse(List<String> path, List<Coordinate> coordinates, double estimatedTime, boolean negativeCycleDetected, String message, List<RouteStep> steps) {
        this.path = path;
